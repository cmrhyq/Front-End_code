...
import React, { forwardRef, useState, useRef, cloneElement, useEffect, useImperativeHandle, isValidElement } from 'react';
...
var Tooltip = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  var getTriggerChildren = function getTriggerChildren(children2) {
    ...
    if ((children2.type === "button" || displayName === "Button") && children2 !== null && children2 !== void 0 && (_children2$props = children2.props) !== null && _children2$props !== void 0 && _children2$props.disabled) {
      ...
      var child = /*#__PURE__*/cloneElement(children2, {
  ...
  }, restProps), /*#__PURE__*/isValidElement(children) ? getTriggerChildren(children) : children);
});
