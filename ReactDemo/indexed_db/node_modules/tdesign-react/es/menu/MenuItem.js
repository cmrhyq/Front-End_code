...
var MenuItem = function MenuItem(props) {
  ...
  return /* @__PURE__ */React.createElement("li", {
    ref: menuItemRef,
    className: classNames("".concat(classPrefix, "-menu__item"), className, (_classNames = {}, _defineProperty(_classNames, "".concat(classPrefix, "-is-disabled"), disabled), _defineProperty(_classNames, "".concat(classPrefix, "-is-active"), value === active), _defineProperty(_classNames, "".concat(classPrefix, "-menu__item--plain"), !icon), _classNames)),
    style: _objectSpread({}, style),
    onClick: handleClick
  }, icon, href ? /* @__PURE__ */React.createElement("a", {
    href: href,
    target: target,
