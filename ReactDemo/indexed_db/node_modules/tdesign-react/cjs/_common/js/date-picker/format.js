...
function parseToDayjs(value, format, timeOfDay) {
  ...
  return dayjs__default["default"](dateText, format).isValid() ? dayjs__default["default"](dateText, format) : dayjs__default["default"](dateText);
}
...
function formatRange(_ref) {
  ...
  if (dayjsDateList.some(function (r) {
    ...
    _common_js_log_log["default"].error("DatePicker", "\u8BF7\u68C0\u67E5 format\u3001valueType\u3001value \u683C\u5F0F\u662F\u5426\u6709\u6548.\nformat: '".concat(format, "' valueType: '").concat(targetFormat, "' value: '").concat(newDate, "'"));
    return [];
  }
...
function isValidDate(value, format) {
  if (Array.isArray(value)) {
    if (format === "time-stamp") return value.every(function (v) {
      return dayjs__default["default"](v).isValid();
    });
  ...
  if (format === "time-stamp") return dayjs__default["default"](value).isValid();
