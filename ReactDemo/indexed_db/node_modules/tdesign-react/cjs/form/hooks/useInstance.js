...
var index = require('../../_chunks/dep-266b1890.js');
...
var isEmpty = require('../../_chunks/dep-ca4cc26d.js');
...
function formatValidateResult(validateResultList) {
  ...
  Object.keys(result).forEach(function (key) {
    ...
    if (result[key] && key.includes(",")) {
      ...
      configProvider_ConfigContext.merge_1(result, fieldValue);
      delete result[key];
    }
  });
  return isEmpty.isEmpty_1(result) ? true : result;
}
...
function useInstance(props, formRef, formMapRef) {
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              list = toConsumableArray._toConsumableArray(formMapRef.current.values()).filter(function (formItemRef) {
                ...
                return isFunction.isFunction_1(formItemRef === null || formItemRef === void 0 ? void 0 : (_formItemRef$current15 = formItemRef.current) === null || _formItemRef$current15 === void 0 ? void 0 : _formItemRef$current15.validate) && needValidate(formItemRef === null || formItemRef === void 0 ? void 0 : (_formItemRef$current16 = formItemRef.current) === null || _formItemRef$current16 === void 0 ? void 0 : _formItemRef$current16.name, fields);
          ...
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              list = toConsumableArray._toConsumableArray(formMapRef.current.values()).filter(function (formItemRef) {
                ...
                return isFunction.isFunction_1(formItemRef === null || formItemRef === void 0 ? void 0 : (_formItemRef$current17 = formItemRef.current) === null || _formItemRef$current17 === void 0 ? void 0 : _formItemRef$current17.validateOnly) && needValidate(formItemRef === null || formItemRef === void 0 ? void 0 : (_formItemRef$current18 = formItemRef.current) === null || _formItemRef$current18 === void 0 ? void 0 : _formItemRef$current18.name, fields);
              }).map(function (formItemRef) {
  ...
  function setFields() {
    ...
    fields.forEach(function (field) {
      ...
      var formItemRef = getMapValue(name, formMapRef);
      formItemRef === null || formItemRef === void 0 ? void 0 : (_formItemRef$current8 = formItemRef.current) === null || _formItemRef$current8 === void 0 ? void 0 : _formItemRef$current8.setField(_objectSpread({}, restFields));
    });
  }
