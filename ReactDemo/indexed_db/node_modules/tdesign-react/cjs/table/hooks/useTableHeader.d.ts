...
export default function useTableHeader({ columns }: UseTableHeaderParams): {
    ...
    renderTitleWidthIcon: ([title, sortIcon, filterIcon]: ReactNode[], col: PrimaryTableCol<TableRowData>, colIndex: number, ellipsisTitle: BaseTableCol['ellipsisTitle'], attach: HTMLElement) => JSX.Element;
};
